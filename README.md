...
- [SImpEx](https://simpex.spedion.de/simpex/3.1/Services/MessageService.asmx) - SPEDION Import / Export interface for bidirectional data exchange.
Sending of free texts and tours. Collection of location, activity and tour status messages
